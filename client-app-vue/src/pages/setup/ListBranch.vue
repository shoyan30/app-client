<template>
        ...
        <div class="btn-group w-100" role="group">
          ...
          <div class="btn-group" role="group">
            ...
            <div class="dropdown-menu">
              <button class="dropdown-item" data-bs-toggle="offcanvas" href="#page-entry-branch" role="button"
                aria-controls="page-entry-branch">
                <i class="fa fa-plus m-1"></i> Create
              </button>
              <button class="dropdown-item" data-id="crm_c1" onclick="AppGoShowModal('app-page-help-content',this);">
      ...
      <table id="table-slots" class="table table-vcenter table-hover">
        ...
        <tbody>
          <tr v-for="branch in branches" :key="branch.Id">
            ...
            <td>
              <div class="btn-group w-100" role="group">
                <a type="button" class="btn btn-secondary" @click="editBranch(branch)" title="Edit"><i
                    class="fas fa-edit text-white"></i></a>
                <div class="btn-group" role="group">
                  <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false"></button>
                  <div class="dropdown-menu" style="">
                    <button type="button" class="dropdown-item" title="Delete" @click="removeBranch(branch.Id)">
                      <i class="fa fa-trash text-danger icon dropdown-item-icon"></i>Delete
                    </button>
                  </div>
                </div>
              </div>
  ...
  <div id="page-entry-branch" class="offcanvas offcanvas-end offcanvas-size-75" tabindex="-1"
    aria-labelledby="page-entry-branchLabel">
    <div class="card-status-top bg-red"></div>
    <div class="offcanvas-header p-2">
      <h2 class="offcanvas-title col" id="page-entry-branchLabel">{{ isEdit ? "Edit Branch" : "Add Branch" }}</h2>
      <button type="button" class="btn btn-square btn-ghost-danger w-10" data-bs-dismiss="offcanvas" aria-label="Close"
        onclick="SLOTS.PageGoClear('destroy-child-components',this)"><i class="fas fa-sign-out-alt"></i></button>
    </div>
